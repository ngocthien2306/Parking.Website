...
namespace InfrastructureCore.DataAccess.Engines
{
    /// <summary>
    ...
    public class MsDbDacBase : IDisposable
    {
        ...
        ///// <summary>
        ///// Æ¯Àû DBÀÇ CRUD µîÀ» ±¸ÇöÇÏ±â À§ÇÑ command °´Ã¼µé
        ///// </summary>
        ...
        /// <returns>True if OK, False means error occur. Get the error rows by 
        /// dsObject.Tables[0].GetErrors() to get rows having errors</returns>
        protected Result UpdateData(DataSet dsObject, SqlTransaction trans)
        {
        ...
        /// <returns>True if OK, False means error occur. Get the error rows by 
        /// dsObject.Tables[0].GetErrors() to get rows having errors</returns>
        protected Result UpdateData(DataSet dsObject, string srcTable, SqlTransaction trans)
        {
        ...
        /// <returns>True if OK, False means error occur. Get the error rows by 
        /// dsObject.Tables[0].GetErrors() to get rows having errors</returns>
        protected Result UpdateData2(DataSet dsObject, SqlTransaction trans)
        {
        ...
        /// <returns>True if OK, False means error occur. Get the error rows by 
        /// dsObject.Tables[0].GetErrors() to get rows having errors</returns>
        protected Result UpdateData2(DataSet dsObject, string srcTable, SqlTransaction trans)
        {
            int nResult = -1;
        ...
        protected Result UpdateData2(DataSet dsObject, string srcTable, DbTransaction trans)
        {
            ...
            try
            {
                ...
                daCMAX.InsertCommand.Transaction = (SqlTransaction)trans;
                daCMAX.UpdateCommand.Transaction = (SqlTransaction)trans;
                daCMAX.DeleteCommand.Transaction = (SqlTransaction)trans;
